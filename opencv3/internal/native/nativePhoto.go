...
func AlignMTBNative_shiftMat_0(nativeObj int64, src_nativeObj int64, dst_nativeObj int64, shift_x float64, shift_y float64) {
	C.Java_org_opencv_photo_AlignMTB_shiftMat_10(clzEnv, clzObj,
		(C.jlong)(nativeObj), (C.jlong)(src_nativeObj), (C.jlong)(dst_nativeObj), (C.jdouble)(shift_x), (C.jdouble)(shift_y))
}
...
func CalibrateRobertsonNative_getRadiance_0(nativeObj int64) int64 {
	return int64(C.Java_org_opencv_photo_CalibrateRobertson_getRadiance_10(clzEnv, clzObj, (C.jlong)(nativeObj)))
}
...
func PhotoNative_colorChange_0(src_nativeObj int64, mask_nativeObj int64, dst_nativeObj int64, red_mul float32, green_mul float32, blue_mul float32) {
	C.Java_org_opencv_photo_Photo_colorChange_10(clzEnv, clzObj,
		(C.jlong)(src_nativeObj), (C.jlong)(mask_nativeObj), (C.jlong)(dst_nativeObj), (C.jfloat)(red_mul), (C.jfloat)(green_mul), (C.jfloat)(blue_mul))
}

func PhotoNative_colorChange_1(src_nativeObj int64, mask_nativeObj int64, dst_nativeObj int64) {
	C.Java_org_opencv_photo_Photo_colorChange_11(clzEnv, clzObj,
		(C.jlong)(src_nativeObj), (C.jlong)(mask_nativeObj), (C.jlong)(dst_nativeObj))
}
...
func PhotoNative_createCalibrateRobertson_0(max_iter int, threshold float32) int64 {
	return int64(C.Java_org_opencv_photo_Photo_createCalibrateRobertson_10(clzEnv, clzObj, (C.jint)(max_iter), (C.jfloat)(threshold)))
}

func PhotoNative_createCalibrateRobertson_1() int64 {
	return int64(C.Java_org_opencv_photo_Photo_createCalibrateRobertson_11(clzEnv, clzObj))
}
...
func PhotoNative_stylization_0(src_nativeObj int64, dst_nativeObj int64, sigma_s float32, sigma_r float32) {
	C.Java_org_opencv_photo_Photo_stylization_10(clzEnv, clzObj,
		(C.jlong)(src_nativeObj), (C.jlong)(dst_nativeObj), (C.jfloat)(sigma_s), (C.jfloat)(sigma_r))
}

func PhotoNative_stylization_1(src_nativeObj int64, dst_nativeObj int64) {
	C.Java_org_opencv_photo_Photo_stylization_11(clzEnv, clzObj,
		(C.jlong)(src_nativeObj), (C.jlong)(dst_nativeObj))
}
...
func TonemapDurandNative_delete(nativeObj int64) {
	C.Java_org_opencv_photo_TonemapDurand_delete(clzEnv, clzObj, (C.jlong)(nativeObj))
}
...
func TonemapMantiukNative_getSaturation_0(nativeObj int64) float32 {
	return float32(C.Java_org_opencv_photo_TonemapMantiuk_getSaturation_10(clzEnv, clzObj, (C.jlong)(nativeObj)))
}
...
func TonemapReinhardNative_getIntensity_0(nativeObj int64) float32 {
	return float32(C.Java_org_opencv_photo_TonemapReinhard_getIntensity_10(clzEnv, clzObj, (C.jlong)(nativeObj)))
}
