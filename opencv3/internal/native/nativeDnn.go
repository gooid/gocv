...
func DictValueNative_getStringValue_0(nativeObj int64, idx int) string {
	return togostring(C.Java_org_opencv_dnn_DictValue_getStringValue_10(clzEnv, clzObj, (C.jlong)(nativeObj), (C.jint)(idx)))
}

func DictValueNative_getStringValue_1(nativeObj int64) string {
	return togostring(C.Java_org_opencv_dnn_DictValue_getStringValue_11(clzEnv, clzObj, (C.jlong)(nativeObj)))
}
...
func ImporterNative_populateNet_0(nativeObj int64, net_nativeObj int64) {
	C.Java_org_opencv_dnn_Importer_populateNet_10(clzEnv, clzObj,
		(C.jlong)(nativeObj), (C.jlong)(net_nativeObj))
}
...
func LayerNative_get_name_0(nativeObj int64) string {
	return togostring(C.Java_org_opencv_dnn_Layer_get_1name_10(clzEnv, clzObj, (C.jlong)(nativeObj)))
}
...
func LayerNative_get_type_0(nativeObj int64) string {
	return togostring(C.Java_org_opencv_dnn_Layer_get_1type_10(clzEnv, clzObj, (C.jlong)(nativeObj)))
}
