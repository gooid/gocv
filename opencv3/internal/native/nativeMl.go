...
func ANN_MLPNative_getTrainMethod_0(nativeObj int64) int {
	return int(C.Java_org_opencv_ml_ANN_1MLP_getTrainMethod_10(clzEnv, clzObj, (C.jlong)(nativeObj)))
}
...
func DTreesNative_getMaxCategories_0(nativeObj int64) int {
	return int(C.Java_org_opencv_ml_DTrees_getMaxCategories_10(clzEnv, clzObj, (C.jlong)(nativeObj)))
}
...
func KNearestNative_findNearest_0(nativeObj int64, samples_nativeObj int64, k int, results_nativeObj int64, neighborResponses_nativeObj int64, dist_nativeObj int64) float32 {
	return float32(C.Java_org_opencv_ml_KNearest_findNearest_10(clzEnv, clzObj, (C.jlong)(nativeObj), (C.jlong)(samples_nativeObj), (C.jint)(k), (C.jlong)(results_nativeObj),
		(C.jlong)(neighborResponses_nativeObj), (C.jlong)(dist_nativeObj)))
}
...
func LogisticRegressionNative_setLearningRate_0(nativeObj int64, val float64) {
	C.Java_org_opencv_ml_LogisticRegression_setLearningRate_10(clzEnv, clzObj, (C.jlong)(nativeObj), (C.jdouble)(val))
}
...
func LogisticRegressionNative_setTermCriteria_0(nativeObj int64, val_type int, val_maxCount int, val_epsilon float64) {
	C.Java_org_opencv_ml_LogisticRegression_setTermCriteria_10(clzEnv, clzObj, (C.jlong)(nativeObj), (C.jint)(val_type), (C.jint)(val_maxCount), (C.jdouble)(val_epsilon))
}
...
func SVMNative_getDefaultGridPtr_0(param_id int) int64 {
	return int64(C.Java_org_opencv_ml_SVM_getDefaultGridPtr_10(clzEnv, clzObj, (C.jint)(param_id)))
}
...
func SVMNative_getSupportVectors_0(nativeObj int64) int64 {
	return int64(C.Java_org_opencv_ml_SVM_getSupportVectors_10(clzEnv, clzObj, (C.jlong)(nativeObj)))
}
...
func SVMNative_setC_0(nativeObj int64, val float64) {
	C.Java_org_opencv_ml_SVM_setC_10(clzEnv, clzObj,
		(C.jlong)(nativeObj), (C.jdouble)(val))
}
...
func SVMNative_setP_0(nativeObj int64, val float64) {
	C.Java_org_opencv_ml_SVM_setP_10(clzEnv, clzObj,
		(C.jlong)(nativeObj), (C.jdouble)(val))
}
...
func SVMNative_trainAuto_0(nativeObj int64, samples_nativeObj int64, layout int, responses_nativeObj int64, kFold int, Cgrid_nativeObj int64, gammaGrid_nativeObj int64, pGrid_nativeObj int64, nuGrid_nativeObj int64, coeffGrid_nativeObj int64, degreeGrid_nativeObj int64, balanced bool) bool {
	return togobool(C.Java_org_opencv_ml_SVM_trainAuto_10(clzEnv, clzObj, (C.jlong)(nativeObj), (C.jlong)(samples_nativeObj), (C.jint)(layout), (C.jlong)(responses_nativeObj),
		(C.jint)(kFold), (C.jlong)(Cgrid_nativeObj), (C.jlong)(gammaGrid_nativeObj), (C.jlong)(pGrid_nativeObj), (C.jlong)(nuGrid_nativeObj), (C.jlong)(coeffGrid_nativeObj), (C.jlong)(degreeGrid_nativeObj), tojboolean(balanced)))
}
...
func StatModelNative_calcError_0(nativeObj int64, data_nativeObj int64, test bool, resp_nativeObj int64) float32 {
	return float32(C.Java_org_opencv_ml_StatModel_calcError_10(clzEnv, clzObj, (C.jlong)(nativeObj), (C.jlong)(data_nativeObj), tojboolean(test), (C.jlong)(resp_nativeObj)))
}
...
func StatModelNative_predict_0(nativeObj int64, samples_nativeObj int64, results_nativeObj int64, flags int) float32 {
	return float32(C.Java_org_opencv_ml_StatModel_predict_10(clzEnv, clzObj, (C.jlong)(nativeObj),
		(C.jlong)(samples_nativeObj), (C.jlong)(results_nativeObj), (C.jint)(flags)))
}

func StatModelNative_predict_1(nativeObj int64, samples_nativeObj int64) float32 {
	return float32(C.Java_org_opencv_ml_StatModel_predict_11(clzEnv, clzObj, (C.jlong)(nativeObj),
		(C.jlong)(samples_nativeObj)))
}
