...
func Calib3dNative_stereoRectifyUncalibrated_0(points1_nativeObj int64, points2_nativeObj int64, F_nativeObj int64, imgSize_width float64, imgSize_height float64, H1_nativeObj int64, H2_nativeObj int64, threshold float64) bool {
	return togobool(C.Java_org_opencv_calib3d_Calib3d_stereoRectifyUncalibrated_10(clzEnv, clzObj, (C.jlong)(points1_nativeObj), (C.jlong)(points2_nativeObj), (C.jlong)(F_nativeObj),
		(C.jdouble)(imgSize_width), (C.jdouble)(imgSize_height), (C.jlong)(H1_nativeObj), (C.jlong)(H2_nativeObj), (C.jdouble)(threshold)))
}
...
func Calib3dNative_stereoRectifyUncalibrated_1(points1_nativeObj int64, points2_nativeObj int64, F_nativeObj int64, imgSize_width float64, imgSize_height float64, H1_nativeObj int64, H2_nativeObj int64) bool {
	return togobool(C.Java_org_opencv_calib3d_Calib3d_stereoRectifyUncalibrated_11(clzEnv, clzObj, (C.jlong)(points1_nativeObj), (C.jlong)(points2_nativeObj), (C.jlong)(F_nativeObj),
		(C.jdouble)(imgSize_width), (C.jdouble)(imgSize_height), (C.jlong)(H1_nativeObj), (C.jlong)(H2_nativeObj)))
}
